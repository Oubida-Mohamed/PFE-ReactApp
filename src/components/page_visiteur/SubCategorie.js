    ...
    return (<>
            ...
            <div className="rounded-lg cursor-pointer  overflow-hidden xl:w-[290px] md:w-[270px]  w-[240px] lg:w-[18rem] xl:h-[350px] h-[270px] relative  shadow-2xl">
                ...
                <div className="absolute  my-5">
                    <p className="md:text-lg text-[16px] font-Inter w-full ml-4  font-semibold text-white">{props.service.description}</p>
                    <h1 className="md:text-3xl text-2xl my-2 ml-7 font-bold text-white ">{props.service.nom}</h1>
                </div>
            </div> :
                <div className="rounded-lg  overflow-hidden xl:w-[290px] md:w-[270px]  w-[240px] lg:w-[18rem] xl:h-[350px] h-[270px] relative  shadow-2xl">
                    ...
                    <div className="absolute  ml-4 my-4 ">
                        <p className="text-3xl  font-Irish Grover md:text-[24px] text-[16px] font-semibold text-white ">{props.service.description}</p>
                    </div>
                </div>
            }
        </>
