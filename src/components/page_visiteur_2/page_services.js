...
function PageServices() {
  ...
  <div className="container mx-auto mt-[150px]">
    ...
    <div className=" mt-10 md:flex">
      ...
      <div className="flex mx-auto px-8 md:mt-[20px] mt-[50px] space-x-[53px] z-0">
          <ToggleButton label={'Local sellers'} event={handleChange}/>
          <ToggleButton label={'Online sellers'} event={handleChange}/>
      </div>
    </div>
  {/* Services */}
  <div className="place-items-center my-10 grid min-[1060px]:grid-cols-4 min-[1060px]:gap:4 min-[810px]:grid-cols-3 min-[810px]:gap-3 min-[540px]:grid-cols-2 min-[540px]:gap:2 grid-cols-1">
